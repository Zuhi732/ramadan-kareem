...
const Dua = () => {
  ...
  // সেহরি ও ইফতার (সাউন্ড ছাড়া)
  const duas = {
    sehri: {
      id: "sehri",
      title: "সেহরির দোয়া",
      arabic:
        "নাওয়াইতু আন আছুম্মা গাদাম মিন শাহরি রমাদজানাল মুবারাকি ফারদাল্লাকা...",
      bangla:
        "হে আল্লাহ! আগামীকাল পবিত্র রমজান মাসে তোমার সন্তুষ্টি লাভের উদ্দেশ্যে রোজা রাখার নিয়ত করলাম।",
